...
@section('content')
  ...
  <div class="mb-3">
    <label class="form-label text-start d-block">Nama Mahasiswa</label>
    <input type="text" class="form-control" id="nama_mahasiswa">
  </div>

  <div class="mb-3">
    <label class="form-label text-start d-block">NIM Mahasiswa</label>
  ...
  <div class="mb-3">
    ...
    <div id="upload-section" class="border p-3 bg-light d-flex flex-column">
      ...
      <!-- Alasan di bawahnya -->
      <label class="form-label text-start d-block mt-2">Alasan:</label>
