...
@endforelse
                  ...
                  <tr id="pelanggaranForm{{ $key }}" style="display: none;">
                    <form method="POST" action="{{ route('student_behaviors.store') }}">
                      ...
                      <!-- Pelanggaran -->
                      <td>
                        <input type="text" name="pelanggaran" class="form-control" placeholder="Pelanggaran">
                      </td>

                      <!-- Unit (read-only) -->
                      <td>
                        <input type="text" name="unit" class="form-control" value="Keasramaan" readonly>
                      </td>
                      ...
                      <td>
                        <!-- Tindakan input -->
                        <input type="text" name="tindakan" class="form-control mb-2" placeholder="Tindakan">

                        <!-- Buttons on a new line -->
                        <div>
                          <button type="submit" class="btn btn-success btn-sm me-1">Tambah</button>
                ...
                <tbody>
                  ...
                  <tr id="perbuatanBaikForm{{ $key }}" style="display: none;">
                    <form method="POST" action="{{ route('student_behaviors.store') }}">
                      ...
                      <!-- Perbuatan Baik -->
                      <td>
                        <input type="text" name="perbuatan_baik" class="form-control" placeholder="Perbuatan Baik">
                      </td>
                      ...
                      <!-- Kredit Poin -->
                      <td>
                        <input type="number" name="kredit_poin" class="form-control" placeholder="Kredit Poin">
                      </td>
