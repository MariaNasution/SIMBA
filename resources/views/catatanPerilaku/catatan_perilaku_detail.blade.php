                    ...
                    @if($hasPelanggaran)
                      <td>
                        @if (isset($pelanggaran['local_id']))
                          ...
                          <!-- Delete menggunakan full form submission -->
                          <button type="button" class="btn btn-outline-danger btn-sm delete-btn" 
                            data-id="{{ $pelanggaran['local_id'] }}" 
                            data-url="{{ route('student_behaviors.destroy', $pelanggaran['local_id']) }}" 
              ...
              <table class="table table-bordered table-striped" style="margin-top: 0; border-top: none;">
                ...
                <tbody>
                  ...
                  <tr class="data-row">
                    ...
                    @if($hasPerbuatanBaik)
                      <td>
                        @if (isset($perbuatan['local_id']))
                          <a href="{{ route('student_behaviors.edit', $perbuatan['local_id']) }}"
                             class="btn btn-outline-primary btn-sm" title="Edit">
                            <i class="fas fa-pencil-alt"></i>
                          </a>
                          <button type="button" class="btn btn-outline-danger btn-sm delete-btn" 
                            data-id="{{ $perbuatan['local_id'] }}" 
                            data-url="{{ route('student_behaviors.destroy', $perbuatan['local_id']) }}"
