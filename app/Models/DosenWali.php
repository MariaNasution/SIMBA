...
class DosenWali extends Model
{
    ...
    protected $fillable = ['ID_Dosen_Wali', 'username', 'nama'];

    /**
     * Relationship with Dosen model.
     * Each DosenWali belongs to a Dosen (lecturer).
     */
    public function dosen()
    {
        return $this->belongsTo(Dosen::class, 'username', 'username'); // Link via username
    }
    ...
    {
        return $this->hasMany(Mahasiswa::class, 'ID_Dosen', 'ID_Dosen'); // Link via ID_Dosen
    }
}